...
public:
	// 重写父类的构造函数
	// phoenix(string name, string type, int HP, int MP, int ATK, int DEF, int SPD, int CRI, int LV, int EXP, int EXP_Need);
	phoenix(string name, string type, int HP, int MP, int ATK, int DEF, int SPD);
	~phoenix();
